...
from colossalai.booster.plugin import GeminiPlugin,TorchFSDPPlugin, LowLevelZeroPlugin, TorchDDPPlugin
...
def main():
    ...
    parser.add_argument('-p',
                        ...
                        type=str,
                        default='torch_ddp',
                        choices=['torch_ddp', 'torch_ddp_fp16', 'fsdp', 'low_level_zero'],
                        help="plugin to use")
    parser.add_argument(
        "--model_type",
        type=str,
